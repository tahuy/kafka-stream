...
public class SimpleProducer {
    ...
    public static void main(String[] args) {
        ...
        properties.put("key.serializer", "bbejeck.chapter_2.producer.PurchaseKeySerializer"/*"org.apache.kafka.common.serialization.StringSerializer"*/);
        ...
        PurchaseKey key = new PurchaseKey("12334", new Date());
